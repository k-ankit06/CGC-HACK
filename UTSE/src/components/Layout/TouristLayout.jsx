...
//               </svg>
//             </button>
//             <h1 className="ml-2 text-xl font-bold">Tourist Safety</h1>
//           </div>

//           <div className="hidden lg:flex items-center space-x-4">
//             <Link to="/tourist/dashboard" className="hover:text-indigo-200">
//               Dashboard
//             </Link>
//             <Link to="/tourist/safe-routes" className="hover:text-indigo-200">
//               Safe Routes
//             </Link>
//             <Link to="/tourist/safety-info" className="hover:text-indigo-200">
//               Safety Info
//             </Link>
//             <Link to="/tourist/emergency-help" className="hover:text-indigo-200">
//               Emergency Help
//             </Link>
//           </div>
...
//               <p className="text-sm">Welcome, {user?.name || 'Tourist'}</p>
//             </div>
//             <button
//               onClick={logout}
      ...
      <header className="bg-indigo-700 text-white shadow-md">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <Link to="/tourist/dashboard" className="ml-2">
