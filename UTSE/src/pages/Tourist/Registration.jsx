...
const TouristRegistration = () => {
  ...
  const [formData, setFormData] = useState({
      ...
      passportNumber: user?.passportNumber || '', aadhaarNumber: user?.aadhaarNumber || '', 
  ...
  const handleSubmit = () => {
    ...
    if (!isAddingMember) {
      ...
      alert(`${newMember.fullName} has been successfully added to your group.`);
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto">
      <div className="card">
        ...
        <p className="text-gray-600">{isAddingMember ? `Adding member ${groupMembers.length + 1} to your group.` : 'Complete your registration to get your Smart Tourist Card.'}</p>
