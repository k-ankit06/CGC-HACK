...
const MyTouristCard = () => {
  ...
  const verificationUrl = `${window.location.origin}/verify/${touristData.touristId}`;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl p-8 text-white shadow-2xl">
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="bg-white p-3 rounded-xl shadow-lg">
              <QRCodeReact id="card-qr-code" value={verificationUrl} size={100} level="H" />
            </div>
          </div>
          <div className="flex flex-col md:flex-row gap-6 mb-6">
            ...
            <div className="flex-1">
              <h4 className="text-2xl font-bold">{touristData.fullName} {isGroupRegistration && <span className="text-base font-normal">(Group Leader)</span>}</h4>
      ...
      {/* ...Action buttons and other sections... */}
    </div>
  )
}
