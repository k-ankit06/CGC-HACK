...
const TouristDashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchNearbyAttractions = () => {
      const attractions = [
        { name: 'India Gate', distance: '2.5 km', rating: 4.5 },
        { name: 'Rashtrapati Bhavan', distance: '3.0 km', rating: 4.7 },
        { name: 'Lodhi Gardens', distance: '4.2 km', rating: 4.3 },
        { name: 'Qutub Minar', distance: '12.0 km', rating: 4.8 },
        { name: 'Humayun\'s Tomb', distance: '10.5 km', rating: 4.6 }
      ];
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h1 className="text-2xl font-bold text-gray-800 mb-4">Tourist Dashboard</h1>
        <p className="text-gray-600">Welcome, {user?.name || 'Tourist'}</p>
      </motion.div>
      ...
      >
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-gray-700">{touristData.name}</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700">{touristData.country}</p>
            </motion.div>
            ...
            >
              ...
              <p className={`text-gray-700 ${touristData.status === 'active' ? 'text-green-600' : 'text-gray-500'}`}>
                {touristData.status}
              </p>
            </motion.div>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-3xl">{weather.temperature}°C</p>
            ...
            {nearbyAttractions.map((attraction, index) => (
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <p className="font-medium text-yellow-600">★ {attraction.rating}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {[
            { title: 'Emergency Help', icon: '🚨', path: '/tourist/emergency-help' },
            { title: 'Safe Routes', icon: '🗺️', path: '/tourist/safe-routes' },
            { title: 'Safety Info', icon: 'ℹ️', path: '/tourist/safety-info' },
            { title: 'My Tourist Card', icon: '🆔', path: '/tourist/my-tourist-card' },
            { title: 'Travel Guide', icon: '🌍', path: '/tourist/travel-guide' },
            { title: 'Language Translator', icon: '🗣️', path: '/tourist/language-translator' }
          ].map((action, index) => (
            <motion.div
              key={index}
              whileHover={{ scale: 1.05 }}
